...
bk_bn_img= PhotoImage(file='left-3.png',master=root)
fr_bn_img= PhotoImage(file='right-3.png',master=root)
pl_bn_img= PhotoImage(file='play-3.png',master=root)
pa_bn_img= PhotoImage(file='pause-3.png',master=root)
loop_bn_imp= PhotoImage(file='repeat.png',master=root)
